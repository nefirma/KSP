...
set landing_engines_tag to "Landing".
set MECOcoef to 2.6. // coefficient for MECO calculation. 
set safe_altitude to 750. // safe altitude to start suicide burn
set Laser to ship:partstagged("Laser")[0]:getmodule("LaserDistModule"). //LaserMod - altimiter
set laser_height to 3.5. //height of Laser module above ground level with deployed legs => CHECK IT!
